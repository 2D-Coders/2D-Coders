...
// Update function for Particles (used for background)
      update() {
        this.draw()
        this.position.x += this.velocity.x
        this.position.y += this.velocity.y
...
// Update function for enemy projectiles
    update() {
      this.draw()
      this.position.x += this.velocity.x
      this.position.y += this.velocity.y
...
// Update function for Invader (enemy emoji)    
        update({velocity}) {
          if(this.image) {
          this.draw()
...
// Shoot fuction for enemy projectiles
...
// Update function for grid that enemys move on      
        update() {
          this.position.x += this.velocity.x
          this.position.y += this.velocity.y
...
// for loop for stars in the backround constantly moving
for(let i = 0; i < 100; i++) {
  particles.push(
    new Particle({
    position: {
...
// When enemies explode the particle effect happens in this as well as postion corrections
